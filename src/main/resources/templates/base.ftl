...
<header class="main-header" >
    ...
    <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b>卫</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>卫子鱼的微世界</b></span>
    </a>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
           ...
           <#-- <li><a href="${springMacroRequestContext.contextPath}/profile"><i class="fa fa-gg"></i> <span>子鱼</span></a></li>-->
        </ul>
        <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
...
<!--做导航栏2-->
<#macro leftSideBar2 activeButton>
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <!--<li class="header">HEADER</li>-->
            <!-- Optionally, you can add icons to the links -->
            <li <#if activeButton == 'worldbutton'>class="active"</#if>><a href="#"><i class="fa fa-gg"></i> <span>世界</span></a></li>
            <li <#if activeButton == 'w'>class="active"</#if>><a href="#"><i class="fa fa-gg"></i> <span>无涯</span></a></li>
            <li <#if activeButton == 'e'>class="active"</#if>><a href="#"><i class="fa fa-gg"></i> <span>流音</span></a></li>
            <li <#if activeButton == 'd'>class="active"</#if>><a href="#"><i class="fa fa-gg"></i> <span>千古</span></a></li>
            <li <#if activeButton == 'profile'>class="active"</#if>><a href="${springMacroRequestContext.contextPath}/profile"><i class="fa fa-gg"></i> <span>子鱼</span></a></li>
        </ul>
        <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
...
<#macro model2 activeButton>
    <!-- Main Header -->
    <@header2></@header2>
    <!-- Left side column. contains the logo and sidebar -->
    <@leftSideBar2 activeButton=activeButton></@leftSideBar2>
    <#nested >
    <!-- Main Footer -->
    <@footer></@footer>
    <!-- Control Sidebar -->
